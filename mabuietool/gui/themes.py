...
class ThemeManager:
    DARK = {
        ...
        "text": "#eef2ff", "muted": "#99a4c2", "accent": "#26d6bf", "warn": "#f0b84b", "error": "#ff667a",
    }
    LIGHT = {
        "bg": "#f4f7fb", "panel": "#ffffff", "panel2": "#e9eef7", "border": "#cad3e3",
        "text": "#182033", "muted": "#526079", "accent": "#087e70", "warn": "#9a6500", "error": "#b42335",
    }
    ...
    def stylesheet(cls, theme: str = "dark") -> str:
        ...
        QFrame#topbar, QFrame#sidebar, QFrame#console, QFrame#card {{ background: {c['panel']}; border: 1px solid {c['border']}; border-radius: 10px; }}
